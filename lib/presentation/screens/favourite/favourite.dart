...
class _FavouriteState extends State<Favourite> {
  ...
  void initState() {
    ...
    context.read<FavouriteBloc>().add(
      LoadFavouriteEvent(page: 1, pageSize: 10),
    );
  }
        ...
        builder: (context, state) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
               WishlistProductModel item = productsToShow[index];
              log('image: ${item.images.toString()}');
              return Container(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () {
                                  context.read<FavouriteBloc>().add(
                                    RemoveFavouriteEvent(index, item.irId),
                                  );
                                },
                                child: const Icon(
                                  Icons.close,                                
  ...
  Widget _buildQuantityButton(IconData icon) {
    return Container(
      ...
      child: InkWell(onTap: () {}, child: Icon(icon)),
    );
  }
